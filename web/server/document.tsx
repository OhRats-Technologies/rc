...
function Document({ title, body, user, workspaces = [], path = "/", scripts = [], styles = [], sidebar = "open" }: DocumentProps) {
  ...
  return <html lang="en" data-sidebar={sidebar}>
    <head>
      ...
      <link rel="icon" type="image/svg+xml" href="https://assets.ohrats.party/current/logo.svg"/>
      <link rel="stylesheet" href="https://assets.ohrats.party/current/ohrats.css"/>
      {css && <link rel="stylesheet" href={css}/>} {styles.map(name => assetUrl(name, "css")).filter(Boolean).map(src => <link key={src} rel="stylesheet" href={src}/>)}<script src="https://assets.ohrats.party/current/theme.js"/>
    </head>
