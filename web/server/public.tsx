  ...
  return <nav className="site-nav">
    <div className="nav-container">
      <div className="nav-left">
        <a href="/" className="logo"><img src={logo} alt="OhRats" className="logo-image"/><span className="logo-text">OhRats RC</span></a>
  ...
  return <footer>
    <div className="footer-content">
      <div className="footer-brand">
        <a href="/" aria-label="OhRats RC home"><img src={logo} alt="OhRats" className="footer-logo"/></a>
      ...
      <nav className="footer-links">
        <div className="footer-column"><span className="footer-column-label">Tools</span><a href="https://wakebar.ohrats.party" className="footer-link">WakeBar</a><a href="/" className="footer-link">OhRats RC</a></div>
