    ...
    sections: [
      {
        ...
        body: <>
          ...
          <p>The installer downloads the current GitHub Release binary for the operating system and architecture to <code>~/.local/bin/rc</code> and verifies its SHA-256 checksum. macOS and Linux are supported.</p>
