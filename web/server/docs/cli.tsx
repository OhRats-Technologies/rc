...
export function cliArticle(): DocArticle {
  return {
    slug: "cli",
    title: "CLI",
    intro: "Install, authenticate, enroll devices, and control machines with ohrats-rc.",
    copy: true,
    sections: [
      {
        id: "install",
      ...
      },
      {
        ...
        body: <DocTable><thead><tr><th>Command</th><th>Description</th></tr></thead><tbody>
          ...
          <tr><td><code>ohrats-rc status</code></td><td>Show local enrollment and hosted device status.</td></tr>
          ...
          <tr><td><code>ohrats-rc update</code></td><td>Verify and install a signed newer Node release, then restart the service if installed.</td></tr>
      ...
      },
      {
        ...
        title: "Local state",
        body: <>
          <p>RC state is stored under <code>~/.config/ohrats-rc</code> by default. This includes device identity, RC Lock, device pins, CLI session data, configuration, service logs, and the CLI control private key.</p>
