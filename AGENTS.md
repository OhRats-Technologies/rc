...
- Device presence is always visible in the hierarchy and uses shared semantic positive/negative state tokens. Long child labels truncate to make room for revealed context controls; do not animate/marquee navigation text.
