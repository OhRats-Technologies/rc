...
- Standalone object deletion belongs in the page header when there is no existing object context menu. Action and account deletion use the shared centered delete dialog. Native dialogs must remain explicitly centered despite the shared universal margin reset.
