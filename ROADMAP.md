...
- [x] Correlate MCP receipt, outcome, and timing with server-generated references and fixed privacy-safe error categories; surface references and recovery guidance to callers.
